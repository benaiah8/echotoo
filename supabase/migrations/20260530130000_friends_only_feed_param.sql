-- Optional p_friends_only for home vertical Friends filter (mutual approved follow only).
-- Drops the eight-argument overload before adding the ninth parameter.
