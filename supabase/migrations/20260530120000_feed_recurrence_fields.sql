-- Return is_recurring and recurrence_days in get_feed_with_related_data JSON (feed schedule labels).
-- Same 8-param signature and logic as 20260521120000_feed_occurrence_params.sql.
